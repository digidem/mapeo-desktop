        ...
        },
        {
          ...
          click: function (item, focusedWindow) {
            function createProgressDialog () {
              ...
              child.setMenu(null)
              var HTML = 'file://' + path.resolve(__dirname, '../export_progress.html')
              child.loadURL(HTML)
              return child
            }
            ...
            dialog.showSaveDialog({
              ...
              var t = through(function (chunk, enc, next) {
                n++
                win.webContents.send('export-progress', (n / max))
                next(chunk)
              })

              pump(ex, t, out, function (err) {
