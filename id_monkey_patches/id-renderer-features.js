iD.Features = function(context) {
    ...
    defineFeature('revisar', function isRevisar(entity, resolver, geometry) {
        return entity.tags.revisar
    });

    defineFeature('flora', function isFlora(entity, resolver, geometry) {
        return geometry === 'point' &&
            (entity.tags.arbol || entity.tags.palmera || entity.tags.planta || entity.tags.flora || entity.tags.liana)
    });

    defineFeature('fauna', function isFauna(entity, resolver, geometry) {
        return geometry === 'point' &&
            (entity.tags.fauna)
    });

    defineFeature('caminos_wao', function isCaminoWao(entity, resolver, geometry) {
        return entity.tags.camino && entity.tags.camino !== 'animales'
    });

    defineFeature('caminos_animales', function isCaminoAnimal(entity, resolver, geometry) {
        return entity.tags.camino && entity.tags.camino === 'animales'
    });
    ...
    defineFeature('comunidad', function isComunidad(entity) {
        return entity.tags.comunidad ||
            entity.tags.amenity ||
            entity.tags.historical ||
            entity.tags.place === 'village' ||
            entity.tags.actividad
    });

    defineFeature('natural', function isNatural(entity) {
        return entity.tags.natural && entity.tags.natural !== 'water'
    });


    defineFeature('areas', function isArea(entity, resolver, geometry) {
